package com.jeon.app01.pkg02_bean;

import org.springframework.context.annotation.AnnotationConfigApplicationContext;
import org.springframework.context.support.AbstractApplicationContext;

import com.jeon.app01.pkg01_setter.Contact;
...
public class MainClass {
  ...
  public static void main(String[] args) {
    ...
    AbstractApplicationContext ctx = new AnnotationConfigApplicationContext(AppConfig.class);  // new AnnotationConfigApplicationContext("com.jeon.app01.pkg02_bean");

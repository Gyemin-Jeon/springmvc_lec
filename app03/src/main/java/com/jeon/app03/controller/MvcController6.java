...
public class MvcController6 {
  ...
  // 요청 URL : /webdir6/123
  @RequestMapping(value="/webdir6/{number}")  // 경로에 포함된 변수를 number 라고 부르겠습니다.
  public String req1(@PathVariable(value="number") int number) {  // 경로 변수 number 를 int number 에 저장합니다.

package com.jeon.app07.controller;
...
import com.jeon.app07.service.IBoardService;
...
public class BoardController {
  ...
  public String modify(BoardDto boardDto, RedirectAttributes redirectAttributes) {
    ...
    // 수정 서비스로부터 수정 결과를 받아온 뒤, 해당 정보를 리다이렉트 할 수 있도록 redirectAttribute에 저장합니다.
    ...
    return "redirect:/board/detail.do?boardId={id}";  // 상세보기로 redirect (상세보기 요청을 작성합니다.)

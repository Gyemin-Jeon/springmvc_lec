package com.jeon.app05.controller;
...
import com.jeon.app05.vo.UserVo;

@SessionAttributes(names={"loginUser"})  // Model에 loginUser 속성이 저장되면, HttpSession에도 loginUser 속성으로 함께 저장하세요.
                                         // @SessionAttributes Annotation으로 저장된 속성은 SessionStatus 인터페이스의 setComplete() 메소드를 호출해서 삭제할 수 있습니다.
                                         // HttpSession 인터페이스의 invalidate() 메소드는 동작하지 않습니다.
@Controller
public class MvcController2 {
  ...
  public String login(
      ...
      @ModelAttribute(name="user") // Model에 저장할 속성의 이름을 user로 바꾸기 위해서 사용합니다.
